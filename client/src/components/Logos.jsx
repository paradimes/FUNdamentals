  ...
  return (
    <section className="bg-gray-5 bg-gray-300 dark:bg-gray-800">
      <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        ...
        <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-4 bg-gray-200 dark:bg-gray-400 p-10 lg:p-0 items-center justify-center rounded-full">
